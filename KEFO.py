...
class xcrack():
    ...
    def methodCHI(self, sid, name, psw):
        try:
            ...
            ua=f'[FBAN/Orca- Android;FBAV/'+str(random.randint(22,88))+'.0.0.'+str(random.randint(2222,8888))+';FBBV/'+str(random.randint(2222222,8888888))+';[FBAN/FB4A;FBAV/87.0.0.86.55;FBBV/38842789;FBDM/{density=2.4,width=720,height=1280};FBLC/ff_SN;FBCR/Wing Alpha;FBMF/oppo;FBBD/oppo;FBPN/com.facebook.katana;FBDV/CPH1605;FBSV/6.0.1;nullFBCA/armeabi-v7a:armeabi;]'
            try:
                ls = name.split(' ')[1]
            except:
                ls = fs    
